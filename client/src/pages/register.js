...
const Register = () => {
    ...
    const history = useHistory();
     ...
     const initialState = { fullname: "", username: "", email: "", password: "", cf_password: "", gender: "male",roll_number:"" };
     const [userData, setUserData] = useState(initialState);
     const { fullname, username, email, password, cf_password,roll_number } = userData;
    ...
    return (
      <div className="auth_page">
        <form onSubmit={handleSubmit} className="inner-shadow">
          ...
          <div className="mb-3">
            <label htmlFor="fullname" className="form-label" placeholder='fullname'>
              Full name
            </label>
  ...
  <div className="outer-shadow hover-in-shadow form-input-wrap">
    <input
      ...
      value={roll_number}
      name="roll_number"
      style={{ background: `${alert.roll_number ? "#fd2d6a14" : ""} ` }}
    />
  </div>
  <small className="form-text text-danger">
    {alert.roll_number ? alert.roll_number : ""}
  </small>
</div>
